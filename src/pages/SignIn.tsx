...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen w-full flex">
      ...
      {/* Form area + right spacer: increase spacer width to push form left, decrease to push right */}
      <div className="flex-1 flex min-w-0">
        ...
        {/* Right spacer: increase width (e.g. w-64) to push form left, decrease (e.g. w-24) to push right */}
